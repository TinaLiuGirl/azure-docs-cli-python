...
[Linux VMs](/azure/virtual-machines/virtual-machines-linux-cli-samples?toc=/cli/azure/toc.json&bc=/cli/azure/breadcrumb/toc.json),
[Windows VMs](/azure/virtual-machines/virtual-machines-windows-cli-samples?toc=/cli/azure/toc.json&bc=/cli/azure/breadcrumb/toc.json), 
[Web apps](/azure/app-service-web/app-service-cli-samples?toc=/cli/azure/toc.json&bc=/cli/azure/breadcrumb/toc.json),
and [SQL Database](/azure/sql-database/sql-database-cli-samples?toc=/cli/azure/toc.json&bc=/cli/azure/breadcrumb/toc.json).
